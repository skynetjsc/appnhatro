...
public class FilterPresenter extends Presenter<FilterContract.View> implements FilterContract.Presenter {
    FilterContract.Interactor interactor;

    public FilterPresenter(FilterContract.View view) {
        super(view);
        interactor = new FilterImplRemote(this);
    }
