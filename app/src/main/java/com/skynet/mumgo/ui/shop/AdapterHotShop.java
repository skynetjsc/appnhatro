...
public class AdapterHotShop extends RecyclerView.Adapter<AdapterHotShop.Viewholder> {
    List<Shop> list;
    Context context;
    ...
    public AdapterHotShop(List<Shop> list, Context context, ICallBackListShop iCallback) {
        this.list = list;
